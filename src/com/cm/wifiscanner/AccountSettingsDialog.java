...
public class AccountSettingsDialog extends AlertDialog implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mShowPasswordCheckBox = (CheckBox)mView.findViewById(R.id.account_show_password);
    ...
    private void setButtons(int mode) {
        switch (mode) {
            case EDIT_MODE:
                setButton(BUTTON_EDIT, mContext.getString(R.string.wifi_account_dialog_save), this);
                break;
            case VIEW_MODE:
                setButton(BUTTON_EDIT, mContext.getString(R.string.wifi_account_dialog_edit), this);
                setButton(BUTTON_DELETE, mContext.getString(R.string.wifi_account_dialog_delete),
                        this);
                break;
            default:
                break;
    ...
    public void onClick(DialogInterface dialog, int which) {
        ...
        if (EDIT_MODE == mMode) {
            ...
            if(which == BUTTON_EDIT) {
                ...
                getButton(BUTTON_EDIT).setText(R.string.wifi_account_dialog_save);
