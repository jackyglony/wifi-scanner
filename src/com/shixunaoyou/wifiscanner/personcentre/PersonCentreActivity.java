...
public class PersonCentreActivity extends Activity implements
    ...
    protected void onResume() {
        super.onResume();
        Logger.debug("PersonCentreActivity", "onResume");
    ...
    private void updateLoginStatusText() {
        if (Utils.getLoginStatus(this) == Constants.HAVE_LOGIN) {
            mLoginStatusTextView.setText(R.string.person_centre_login_status);
        } else {
    ...
    private void changeAccount() {
        ...
        int alertDialogWidth = (int) (display.getWidth() * 0.9);
        @SuppressWarnings("deprecation")
        int alertDialogHeight = (int) (display.getHeight() * 0.8);
        dlg.show();
        dlg.getWindow().setLayout(alertDialogWidth, alertDialogHeight);
